...
Rscript --vanilla scripts/cox_parallel.R /mnt/work/hunt/dosage/moms/ /mnt/work/hunt/pheno/HUNT_PROM_surv_moms_sens ./raw_data/samples_ID_moms MOR_PID /mnt/work/pol/gwas/res/survival/moms/test/momsHUNT_PROM_sens_chr
